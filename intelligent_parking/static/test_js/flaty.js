$(function() {
    function e() {
        if (typeof cookie_not_handle_user_settings != "undefined"
                && cookie_not_handle_user_settings == true) {
            return
        }
    ...
    var t = $(".flaty-nav .dropdown-toggle > .fa-bell + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".flaty-nav .dropdown-toggle > .fa-bell").addClass("anim-swing")
    }
    t = $(".flaty-nav .dropdown-toggle > .fa-envelope + .badge");
    if ($(t).length > 0 && parseInt($(t).html()) > 0) {
        $(".flaty-nav .dropdown-toggle > .fa-envelope").addClass(
                "anim-top-down")
    }
    ...
    $("#sidebar-collapse").click(
            function() {
                ...
                if ($("#sidebar").hasClass("sidebar-collapsed")) {
                    $("#sidebar-collapse > i").attr("class",
                            "fa fa-angle-double-right");
                    $.cookie("sidebar-collapsed", "true");
                    $("#sidebar ul.nav-list").parent(".slimScrollDiv")
                            .replaceWith($("#sidebar ul.nav-list"))
                } else {
                    $("#sidebar-collapse > i").attr("class",
    ...
    $("#sidebar .nav > li.active > a > .arrow").removeClass("fa-angle-right")
    ...
    if ($("#nav-horizontal")) {
        var r = function() {
            ...
            if (e > 979) {
                ...
                $("#nav-horizontal .arrow").removeClass("fa-angle-right")
                        .removeClass("fa-angle-down").addClass("fa-caret-down")
            } else {
                $("#nav-horizontal").addClass("nav-xs");
                $("#nav-horizontal .arrow").removeClass("fa-caret-down")
    ...
    var i = [ "blue", "red", "green", "orange", "yellow", "pink", "magenta",
            "gray", "black" ];
    $.each(i, function(e, t) {
        if ($("body").hasClass("skin-" + t)) {
            $("#theme-setting ul.colors > li").removeClass("active");
            $("#theme-setting ul.colors > li:has(a." + t + ")").addClass(
                    "active")
        }
    });
    $.each(i,
            function(e, t) {
                if ($("#navbar").hasClass("navbar-" + t)) {
                    $('#theme-setting ul[data-prefix="navbar-"] > li')
                            .removeClass("active");
                    $(
                            '#theme-setting ul[data-prefix="navbar-"] > li:has(a.'
                                    + t + ")").addClass("active")
                }
                if ($("#main-container").hasClass("sidebar-" + t)) {
                    $('#theme-setting ul[data-prefix="sidebar-"] > li')
                            .removeClass("active");
                    $(
                            '#theme-setting ul[data-prefix="sidebar-"] > li:has(a.'
                                    + t + ")").addClass("active")
                }
            });
    ...
    $(".mail-messages .msg-collapse > a").click(
            function(e) {
                $(this).children("i").addClass("anim-turn180");
                $(this).parents("li").find(".mail-msg-container").slideToggle(
                        500,
                        function() {
                            var e = $(this).parents("li").find(
                                    ".msg-collapse > a").children("i");
                            if ($(this).is(":hidden")) {
    ...
    $('.mail-toolbar > li:first-child > input[type="checkbox"]').change(
            function() {
                var e = false;
                if ($(this).is(":checked")) {
                    e = true
                }
                $(this).parents(".mail-content").find(
                        '.mail-list .ml-left > input[type="checkbox"]').prop(
                        "checked", e);
                var t = $(this).parents(".mail-content")
                        .find(".mail-list > li");
                if (e) {
                    $(t).addClass("checked")
                } else {
