$(function() {
        ...
        $("#form-wizard-1").bootstrapWizard(
                {
                    ...
                    onNext : function(e, t, n) {
                        ...
                        var u = i / r * 100;
                        $("#form-wizard-1").find(".progress-bar").css("width",
                                u + "%");
                        $("html, body").animate({
        ...
        $("#form-wizard-2").bootstrapWizard(
                {
                    ...
                    onNext : function(e, n, r) {
                        ...
                        var f = o / s * 100;
                        $("#form-wizard-2").find(".progress-bar").css("width",
                                f + "%");
                        $("html, body").animate({
    ...
    if (jQuery.plot) {
        ...
        var w = [ [ 1, 35 ], [ 2, 48 ], [ 3, 34 ], [ 4, 54 ], [ 5, 46 ],
        ...
        var S = [ "#88bbc8", "#ed7a53", "#9FC569", "#bbdce3", "#9a3b1b",
                "#5a8022", "#2c7282" ];
        var x = {
            grid : {
                show : true,
